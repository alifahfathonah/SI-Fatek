        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="<?php echo site_url('dosen/profile');?>"><i class="fa fa-user fa-fw"></i>Profile</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('dosen/profile/edit');?>"><i class="fa fa-edit fa-fw"></i>Edit Profile</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('dosen/document');?>"><i class="fa fa-folder fa-fw"></i>Dokumen</a>
					</li>
					<li>
                        <a href="<?php echo site_url("dosen/logout"); ?>"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
