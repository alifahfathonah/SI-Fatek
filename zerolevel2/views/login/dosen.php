...
<head>
	...
	<title>Dosen Login | Portal Fakultas Teknik</title>
	...
	<style type="text/css">
		...
		.intro {
			background: url(<?php echo base_url("images/intro-bg.jpg");?>) no-repeat bottom center scroll;
				...
				<div class="row ">
					...
					<div class="col-md-6 form-login">
						...
						<?php echo form_open();?>
							...
							<?php }?>
							<input type="text" name="identity" placeholder="NIP" rel="txtTooltip1" title="Nomor Induk Pegawai" data-toggle="tooltip" data-placement="right" required>
