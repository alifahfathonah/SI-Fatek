                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php foreach ($list['mahasiswa'] as $key) {?>
                                                    <a href="<?php echo site_url('detail/mahasiswa/').$key['nim'];?>"><?php echo $key['nama'];?></a><br/>
                                                <?php }?>
                                            </td>
                                            <td>
                                            ...
                                            <td style='white-space: nowrap'>
                                                <button type="button" class="btn btn-xs btn-warning waves-effect" data-toggle="modal" data-target="#modalFormPrestasi" data-form="formEdit" data-id="<?php echo $list['idPrestasi'];?>">Edit</button>
                                                <button class="btn btn-xs btn-danger waves-effect buttonHapus" data-id="<?php echo $list['idPrestasi'];?>">Delete</button>
                                            </td> 
                                        </tr> 
                                        <?php $i++;}?>                         
                                    </tbody>
