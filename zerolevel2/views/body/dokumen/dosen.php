<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Daftar Dosen Fakultas Teknik</h2>
                        </div>
                        <div class="body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="150px" class="text-center">
                                                <a href="<?php echo site_url('admin/dokumen/dosen/').$list['nip'];?>" class="btn btn-xs btn-info waves-effect" role="button" title="Lihat Dokumen">
                                                    <i class="material-icons">remove_red_eye</i> Lihat Dokumen
                                                </a>
                                            </td>
